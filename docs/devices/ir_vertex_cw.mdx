...
id: ir_vertex_cw
slug: ir_vertex_cw
title: IR-Vertex 80 in CW
---

We have integrated the IR_Vertex 80 device from CW in Chemotion ELN. This protocol allows remote access to the PC running the Opus software and the transfer of experiment data to the Chemotion ELN’s inbox.
