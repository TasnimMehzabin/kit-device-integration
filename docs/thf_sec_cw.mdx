...
- While saving the file at the local location in the computer, the user has to name the file following the [naming convention](/devices/thf_sec_cw#file-naming-convention-details). In this case the local location is **C:\Data**.
